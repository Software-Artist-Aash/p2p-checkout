 ...
 *
 * Usage:
 *   DIAMOND_ADDRESS=0x... USDC_ADDRESS=0x... npx hardhat run scripts/deploy-integrator-v2.ts --network baseSepolia
 *
 * Optional:
...
async function main() {
  ...
  console.log("Deploying CheckoutIntegratorV2...");
  ...
  console.log(`CheckoutIntegratorV2 deployed to: ${address}`);
